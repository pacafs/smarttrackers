...
ActiveRecord::Schema[7.0].define(version: 2023_05_22_210646) do
  ...
  create_table "measurements", force: :cascade do |t|
    ...
    t.index ["power_gauge_id"], name: "index_measurements_on_power_gauge_id"
  end
  ...
  create_table "power_gauges", force: :cascade do |t|
    t.string "name"
    t.date "start_date"
    t.date "end_date"
    t.string "unit"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_power_gauges_on_user_id"
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["measurement_id"], name: "index_reviews_on_measurement_id"
  ...
  add_foreign_key "measurements", "power_gauges"
  add_foreign_key "motor_alert_locks", "motor_alerts", column: "alert_id"
  add_foreign_key "motor_alerts", "motor_queries", column: "query_id"
  add_foreign_key "motor_note_tag_tags", "motor_note_tags", column: "tag_id"
  add_foreign_key "motor_note_tag_tags", "motor_notes", column: "note_id"
  add_foreign_key "motor_taggable_tags", "motor_tags", column: "tag_id"
  add_foreign_key "power_gauges", "users"
  add_foreign_key "reviews", "measurements"
